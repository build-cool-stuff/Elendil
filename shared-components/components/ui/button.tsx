  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        // Glassmorphic button variants - subtle buttons inside frosted containers
        glass:
          "rounded-xl bg-transparent text-white/70 hover:bg-white/10 hover:text-white transition-all duration-200 ease-out",
        "glass-active":
          "rounded-xl bg-white/15 text-white hover:bg-white/20 transition-all duration-200 ease-out",
        "glass-outline":
          "rounded-xl bg-transparent text-white/80 hover:bg-white/10 hover:text-white transition-all duration-200 ease-out",
        "glass-solid":
          "rounded-xl bg-white/10 hover:bg-white/15 text-white transition-all duration-200 ease-out",
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-10 px-6 has-[>svg]:px-4",
        xl: "h-11 px-8 has-[>svg]:px-6 text-base",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
